...
class Game extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet('hero-idle-sheet', '/assets/hero/idle.png', {frameWidth: 32, frameHeight: 64});
    this.load.spritesheet('hero-pivot-sheet', '/assets/hero/pivot.png', {frameWidth: 32, frameHeight: 64});
    this.load.spritesheet('hero-jump-sheet', '/assets/hero/jump.png', {frameWidth: 32, frameHeight: 64});
    this.load.spritesheet('hero-flip-sheet', '/assets/hero/spinjump.png', {frameWidth: 32, frameHeight: 64});
    this.load.spritesheet('hero-fall-sheet', '/assets/hero/fall.png', {frameWidth: 32, frameHeight: 64});
    this.load.spritesheet('hero-die-sheet', '/assets/hero/bonk.png', {frameWidth: 32, frameHeight: 64});
    ...
    this.load.image('clouds-sheet', '/assets/Clouds.png');
  }
  ...
  update(time, delta) {
    ...
    if(this.hero.getBounds().top > cameraBottom + 100) {
      this.hero.destroy();
      this.addHero();
    }
